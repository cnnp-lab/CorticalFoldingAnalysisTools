...
for subj_id in $subs; do 
	...
	mris_fill -c -r 1 ${subj_id}.pial ${subj_id}.pial.filled.mgz
		
	${matlab} -nodisplay -nosplash -nodesktop -r "make_outer_surface('${subj_id}.pial.filled.mgz', 15, '${subj_id}.pial-outer'); exit;"
		
	mris_extract_main_component ${subj_id}.pial-outer ${subj_id}.pial-outer-main
		
	mris_smooth -nw -n 30 ${subj_id}.pial-outer-main ${subj_id}.pial-outer-smoothed
